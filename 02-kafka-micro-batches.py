...
# Set the API keys
confluentApiKey = "ELK427PR6L6BIOMD"
confluentSecret = "WXmow+MCMGlRwbaoJCRuaepwz5lLQIb1z72vLvQORJRSDbM5DmiaCkl2Dx6ydaTt"
...
# MAGIC %fs
# MAGIC ls  /nov2022/checkpoint/ktopic01_bronze_f1/
...
# MAGIC 
# MAGIC --Query the delta file using SQL
# MAGIC select * from delta.`dbfs:/nov2022/output/ktopic01_bronze_f2`
